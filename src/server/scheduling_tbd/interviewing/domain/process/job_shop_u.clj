...
;;; (s/valid? ::fshop/EADS (:EADS fshop/job-shop-u))
(def job-shop-u
  "A pprinted (JSON?) version of this is what we'll provide to the interviewer at the start of Phase 2 of a job-shop-u problem."
